...
App::App()
        ...
        State{
                ...
                .screens_map = new map<int, InterfaceScreen *>{
                        ...
                        {IdScreens::LAUNCH,         Launch::createScreen()},
                        {IdScreens::LAUNCHTASKLIST, LaunchTaskList::createScreen()},
                        {IdScreens::SPACESHIPLIST,  SpaceshipList::createScreen()},
                        {IdScreens::USERLIST,       UserList::createScreen()}
                }
        }, ROOT_DIR)) {
...
App::~App() {
    ...
    delete dynamic_cast<LaunchTaskList *>(mapScreens.at(IdScreens::LAUNCHTASKLIST));
    delete dynamic_cast<Launch *>(mapScreens.at(IdScreens::LAUNCH));
    delete dynamic_cast<SpaceshipList *>(mapScreens.at(IdScreens::SPACESHIPLIST));
    delete dynamic_cast<UserList *>(mapScreens.at(IdScreens::USERLIST));
